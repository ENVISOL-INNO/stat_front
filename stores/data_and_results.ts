...
// Here to add a type of parameter
export type Parameter = {
  type_of_params: "col" | "col_list" | "num" | "num_list" | "string" | "file" | "txt_list" | "label" ; // here: add text input
  value: Array<string> | string | number | Array<number> | Array<File> ;
}
